                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                            <?php
                                                $select = mysqli_query($con,"SELECT  * FROM users where status='1'");
                                                $i=0;
      ...
      $status='<span class="badge bg-danger">Inactive</span>';
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                            <div class="d-flex gap-3">
                                                                ...
                                                                <a href="" class="text-success" data-bs-toggle="modal" data-bs-target=".orderdetailsModals<?= $row['user_id']; ?>"><i class="mdi mdi-delete font-size-18"></i></a>
                ...
                <div class="modal fade orderdetailsModals<?= $row['user_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="orderdetailsModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="orderdetailsModalLabel">Are You Sure To Restore this  Account <?= $row['firstname']; ?> <?= $row['lastname']; ?></h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                            <form action="action/activecode.php" method="POST" class="custom-validation">
