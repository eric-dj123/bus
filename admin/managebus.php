                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                            <?php
                                                $select = mysqli_query($con,"SELECT  * FROM bus_tbl");
                                                $i=0;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                            <div class="d-flex gap-3">
                                                                ...
                                                                <a href="" class="text-success"  data-bs-toggle="modal" data-bs-target=".orderdetailsModal<?= $row['bus_id']; ?>"><i class="mdi mdi-pencil font-size-18" ></i></a>
