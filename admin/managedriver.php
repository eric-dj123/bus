                        ...
                        <div class="row">
                            ...
                            <?php if ($msg) { ?>
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Driver Management</h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                            <?php
                                                $select = mysqli_query($con,"SELECT  * FROM users where role='driver' and status='0' and status1 is null");
                                                $i=0;
      ...
      $status='<span class="badge bg-danger">Inactive</span>';
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                            ...
                                                            <button type="button" class="btn btn-warning btn-rounded waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".orderdetailsModal<?= $row['user_id']; ?>">Assign</button>
             ...
             <div class="modal fade orderdetailsModal<?= $row['user_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="orderdetailsModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="orderdetailsModalLabel">Are You Sure Assign Bus To Driver <?= $row['firstname']; ?> <?= $row['lastname']; ?> ?</h5>
                            ...
                            <input type="hidden" name="user_id" class="form-control" required data-parsley-minlength="23"
                                ...
                                <div class="mb-2">
                                    ...
                                    <select class="form-select" id="validationCustom03"  name="bus_id"required>
                                        <option selected disabled value="">........Select Bus You Want To Assign ...</option>
                                        <?php
                                    $q2 = mysqli_query($con, "SELECT  * FROM `bus_tbl` WHERE assignstatus is null" );

                                    while ( $r2 = mysqli_fetch_array( $q2 ) ) {
                                      ?>
                                                                    <option value="<?php echo $r2['bus_id']?>">
                                                                        <?php echo $r2['busname']?> <?php echo $r2['platenumber']?></option>
                                                                    <?php } ?>
                                                                </select>
                                    </select>
                                </div>
                ...
                <div class="modal fade orderdetailsModals<?= $row['bus_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="orderdetailsModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="orderdetailsModalLabel">Are You Sure To Disable Bus</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                            <form action="action/disablebus.php" method="POST" class="custom-validation">
