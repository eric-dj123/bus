                        ...
                        <div class="row">
                            ...
                            <?php if ($msg) { ?>
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Drivers Reporting Problem</h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                            <?php
                                                $select = mysqli_query($con,"SELECT  users.firstname,users.lastname,users.lastname,users.user_id,notify_tbl.destination,bus_tbl.bus_id,notify_tbl.dipaturetime,bus_tbl.platenumber,notify_tbl.comment,notify_tbl.dipaturetime,notify_tbl.date_notified FROM notify_tbl JOIN users ON users.user_id=notify_tbl.user_id JOIN bus_tbl ON bus_tbl.bus_id=notify_tbl.bus_id");
                                                $i=0;
