                        ...
                        <div class="modal-content">
                            ...
                            <input type="hidden" name="user_id" class="form-control" required data-parsley-minlength="23"
                                    ...
                                    <select class="form-select" id="validationCustom03"  name="role"required>
                                        ...
                                        <option value="KICUKIRO-NYABUGOGO">KICUKIRO-NYABUGOGO</option>
                                        <option value="NYABUGOGO-KICUKIRO">NYABUGOGO-KICUKIRO</option>
                                        <option value="KICUKIRO-DOWNTOWN">KICUKIRO-DOWNTOWN</option>
                                        <option value="DOWNTOWN-KICUKIRO">DOWNTOWN-KICUKIRO</option>
                                    </select>
                                </div>
                                                            <div class="mb-2">
                                                                <label>Dipature Time</label>
                                                                <div>
                                                                    <input type="time" name="platenumber" class="form-control" required data-parsley-minlength="23"
                                                                        placeholder="Enter Platenumber" />
                                                                </div>
                                                            </div>
                                                            <div class="mb-2">
