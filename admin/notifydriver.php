    ...
    $status='<span class="badge bg-danger">Not Assigned</span>';
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                            ...
                                                            <button type="button" class="btn btn-warning btn-rounded waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".orderdetailsModals<?= $row['user_id']; ?>">Notify Message</button>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="orderdetailsModalLabel">Are You Sure To Notify Driver <?php echo $row['firstname'];?> <?php echo $row['lastname'];?></h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                            <form action="action/sendsms.php" method="POST" class="custom-validation">
                            <input type="hidden" name="user_id" class="form-control" required data-parsley-minlength="23"
                                            ...
                                            <input type="hidden" name="phonenumber" class="form-control" required data-parsley-minlength="23"
                                            value="<?= $row['phonenumber']; ?>" />
                                            <input type="hidden" name="firstname" class="form-control" required data-parsley-minlength="23"
                                            value="<?= $row['firstname']; ?>" />
                                            <input type="hidden" name="lastname" class="form-control" required data-parsley-minlength="23"
                                            value="<?= $row['lastname']; ?>" />
                                            <input type="hidden" name="comment" class="form-control" required data-parsley-minlength="23"
                                            value="Sending success" />

                                            <div class="mb-2">
                                                                <label>PlateNumber</label>
                                                                <div>
                                                                    <input type="text" name="date_notified" class="form-control" required data-parsley-minlength="23"
                                                                        placeholder="Enter Platenumber" value="<?= $row['platenumber']; ?>" readonly/>
                                                                </div>


                                            <div class="mb-2">
                                                                <label>Dipature Date</label>
                                                                <div>
                                                                    <input type="date" name="date_notified" class="form-control" required data-parsley-minlength="23"
                                                                        placeholder="Enter Platenumber" />
                                                                </div>
                                    ...
                                    <select class="form-select" id="validationCustom03"  name="destination"required>
                                        <option selected disabled value="">...Choose Destination...</option>
                                        <option value="FROM-KICUKIRO-TO-NYABUGOGO">KICUKIRO-TO-NYABUGOGO</option>
                                        <option value="FROM-NYABUGOGO-TO-KICUKIRO">NYABUGOGO-KICUKIRO</option>
                                        <option value="FROM-KICUKIRO-TO-DOWNTOWN">KICUKIRO-DOWNTOWN</option>
                                        <option value="FROM-DOWNTOWN-TO-KICUKIRO">DOWNTOWN-KICUKIRO</option>
                                    </select>
                                </div>
                                                            <div class="mb-2">
                                                                <label>Dipature Time</label>
                                                                <div>
                                                                    <input type="time" name="dipaturetime" class="form-control" required data-parsley-minlength="23"
                                                                        placeholder="Enter Platenumber" />
                                                                </div>
                                                            </div>
                                                            <div class="mb-2">
